...
public class CreateNewOpportunityUsingExcel extends BaseClass {
	...
	public void runCreateNewOpportunity(String OpportunityName, String Account) throws InterruptedException {
...
// Enter Opportunity name & Store it
		...
		WebElement AmountVal = driver.findElement(By.xpath("//input[@name='Amount']"));
		AmountVal.sendKeys("75000");
		Thread.sleep(2000);
